...
function Favourites() {
  ...
  // to get genres- to generate buttons dynamically
  useEffect(() => {
  ...
  filteredMovies =
    curGenre == "All Genres"
      ? favourites
      : favourites.filter(
          (movies) => genreids[movies.genre_ids[0]] == curGenre
        );
    ...
    <>
      ...
      <div className="flex justify-center">
        <input
          type="text"
          placeholder="Search"
          className="border border-3 p-2 m-3 text-center"
          value={search}
                    ...
                    <tr key={movie.id}>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-20 w-50">
                            <img
                              className="h-20 w-30 "
      ...
      <Pagination page={curPage} previousPage={goBack} nextPage={goAhead} />
    </>
  );
}
